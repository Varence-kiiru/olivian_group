...
urlpatterns = [
    ...
    path('api/room/<slug:room_name>/favorite/', views.api_toggle_favorite, name='api_toggle_favorite'),
    path('api/subscribe-push/', views.api_subscribe_push, name='api_subscribe_push'),
]
