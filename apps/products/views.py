...
class ProductListView(ListView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if request.headers.get('X-Requested-With') == 'XMLHttpRequest':
            ...
            # Render the product cards with the request so context processors run
            try:
                products_html = render_to_string('website/partials/product_cards.html', full_context, request=request)
